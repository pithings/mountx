...
**Eight subpaths. Each loads only what it needs.**
...
The three `mountx/drivers/*` subpaths are documented in the guide, beside the interface they implement: [built-in drivers](/guide/drivers/built-in). `mountx/auto` and the three transport subpaths are documented in [Transports](/transports), beside the protocols they speak.
