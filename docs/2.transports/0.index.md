...
|                    | [FUSE](/transports/fuse) | [NFS](/transports/nfs)                   |
| ------------------ | ------------------------ | ---------------------------------------- |
| `mount…()` runs on | Linux                    | Linux, macOS                             |
| serves to          | the local kernel         | anything with an NFSv3 or NFSv4.1 client |
...
- [NFS](/transports/nfs) — both versions, and serving without mounting at all.
