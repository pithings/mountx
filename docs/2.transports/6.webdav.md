...
- **A property in a namespace other than `DAV:`.** It is matched on its local name and echoed back in `DAV:`, inside the `404` propstat — bounded to properties this server does not have.
