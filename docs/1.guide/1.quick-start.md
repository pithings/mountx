...
Then poke at it **from another terminal** — `ls -l ~/mountx`, `cat ~/mountx/README.md` — and watch the requests scroll past. Full flags in the [CLI reference](/reference/cli).
...
- [Writing a driver](/guide/drivers) — a complete filesystem in about 60 lines.
